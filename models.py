...
if __name__=="__main__":
    call_zero_shot_pipeline({"prompt_count": 0, "demonstration_count": 0, "prompt_0": "Identify the date or day mentioned in the given text and provide it as the output.", "question_0": "llm conferece on 11/4", "answer_0": "11/4"})