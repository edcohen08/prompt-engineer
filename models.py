...
def load_evaluator_chain():
    ...
    llm = OpenAI(model_name="gpt-3.5-turbo", temperature=0, openai_api_key=st.session_state["openai_api_key"])
...
def load_zero_shot_chain():
    ...
    llm = PromptLayerOpenAIChat(openai_api_key=st.session_state["openai_api_key"], model_name="gpt-3.5-turbo", temperature=0, return_pl_id=True)
